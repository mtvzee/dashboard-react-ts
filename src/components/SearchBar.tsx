...
const SearchBar = () => {
  ...
  return (
    <form
      className="absolute bottom-[250px] left-1/2 -translate-x-1/2 flex items-center  rounded-full w-[600px] h-[60px] px-4 overflow-hidden shadow-[inset_0_0_0_2px_rgba(256,256,256)]"
